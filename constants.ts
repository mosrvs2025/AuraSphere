...
const MOCK_USER_4: User = { id: 'user-4', name: 'Dana', avatarUrl: '/avatars/04.png' };
const MOCK_USER_5: User = { id: 'user-5', name: 'Eli', avatarUrl: '/avatars/05.png' };
const MOCK_USER_6: User = { id: 'user-6', name: 'Fiona', avatarUrl: '/avatars/06.png' };
...
export const MOCK_NOTIFICATIONS: Notification[] = [
    { id: 'notif-1', text: 'Bella started a new room: "🚀 The Future of Frontend Frameworks"', createdAt: new Date(Date.now() - 60000 * 10), isRead: false },
    { id: 'notif-2', text: 'Charlie followed you.', createdAt: new Date(Date.now() - 60000 * 60 * 3), isRead: false },
    { id: 'notif-3', text: 'Your scheduled room "Planning for the Week Ahead" starts in 2 days.', createdAt: new Date(Date.now() - 60000 * 60 * 24), isRead: true },
]
