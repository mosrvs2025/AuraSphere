...
export const StudioIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2} {...props}>
        ...
        <path strokeLinecap="round" strokeLinejoin="round" d="M15.536 8.464a5 5 0 00-7.072 0m7.072 0a5 5 0 010 7.072m-7.072 0a5 5 0 01-3.536-1.464m0 0A5 5 0 016.464 8.464" />
    </svg>
);
...
export const KebabVerticalIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" viewBox="0 0 20 20" fill="currentColor" {...props}>
...
export const ShieldCheckIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2} {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 20.944A12.02 12.02 0 0012 21a12.02 12.02 0 009-14.944c0-1.062-.385-2.058-.984-2.888z" />
    </svg>
);
...
export const ScheduledIcon: React.FC<IconProps> = (props) => (
...
export const GlobeIcon: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2} {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M3.055 11H5a2 2 0 012 2v1a2 2 0 002 2h8a2 2 0 002-2v-1a2 2 0 012-2h1.945M7.707 4.293l.586-.586a2 2 0 012.828 0l2.122 2.122a2 2 0 002.828 0l.585-.586m-9.192 9.192l-.586.586a2 2 0 01-2.828 0L3.055 15M15.293 4.293l.586-.586a2 2 0 00-2.828 0l-2.122 2.122a2 2 0 01-2.828 0l-.585-.586m9.192 9.192l.586.586a2 2 0 002.828 0l2.122-2.122a2 2 0 012.828 0l.586.586M12 21a9 9 0 110-18 9 9 0 010 18z" />
  </svg>
);
...
export const LiveIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2} {...props}>
